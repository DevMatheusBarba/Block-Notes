    ...
    return (
        <Dialog.Root>
            ...
            <Dialog.Portal> {/* Encaminhar o conteudo pra raiz do HTML*/}
                ...
                <Dialog.Content className='fixed overflow-hidden top-[10vh] left-0 right-0 bottom-[10vh] md:inset-auto md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 max-w-[640px] w-full md:h-[60vh] bg-slate-700 md:rounded-md flex flex-col outline-none'>
