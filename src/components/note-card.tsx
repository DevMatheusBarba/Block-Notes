...
export function NoteCard({ note, onNoteDeleted}: NoteCardProps) {
    return (
        <Dialog.Root>
            <Dialog.Trigger className="bg-slate-800 text-left flex flex-col rounded-md p-5 gap-3 overflow-hidden outline-none relative hover:ring-2 hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400">
            ...
            <Dialog.Portal> {/* Encaminhar o conteudo pra raiz do HTML*/}
                ...
                <Dialog.Content className='fixed overflow-hidden inset-0 md:inset-auto md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 max-w-[640px] w-full md:h-[60vh] bg-slate-700 md:rounded-md flex flex-col outline-none'>
                    ...
                    <button type="button"
                        className='bg-slate-800 text-sm text-center w-full py-3 text-slate-300 outline-none font-medium group'
